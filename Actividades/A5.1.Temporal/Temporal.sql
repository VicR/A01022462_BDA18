...
PRIMARY KEY (UserID),
FOREIGN KEY pol (Poliza) REFERENCES poliza,
FOREIGN KEY veh (Vehiculo) REFERENCES vehiculo)
...
period business_time(finicio, ffinal),
PRIMARY KEY (PolizaID))


CREATE TABLE vehiculo (
NIV VARCHAR(18) NOT NULL,
Year int NOT NULL,
